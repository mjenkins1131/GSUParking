...
function start()
{
	...
	viewButton = document.getElementById("viewTabBtn");

	changePassDiv = document.getElementById("changePassDiv");
	addAdminDiv = document.getElementById("addAdminDiv");

	divArray = [analytics, view, edit, create, options];
	tabArray = [analyticsButton,viewButton, editButton, createButton, optionsButton];
...
function logoutRequest()
{
	...
	makeDataRequest(showAdmin1, sessionURL, data);
}
