...
bool Receivepacket()
{
  ...
  if (digitalRead(dio0) == 1) {
    ...
    if (ReceivePkt(message, &length)) {
      ...
      //Dont print this info for our project
      /*
      ...
      */
      ...
      string json = sb.GetString();
      //Only print out the raw encrypted payload
      printf("~%s", b64);
...
int main()
{
  //Ensures that all print statements are immediately printed to standard output.
  //Needed to reliably pipeline output into packet processing 
  setbuf(stdout, NULL);
